...
const GrowCommunication: FunctionComponent = () => {
  return (
    <section className="px-6 py-10 flex flex-col items-center sm:px-14 md:px-32 lg:px-[6.5rem] 2xl:px-[9.5rem] lg:py-24">
      <h1 className="text-2xl font-PoppinsBold text-center text-primaryText lg:text-[2rem] lg:w-[740px] lg:gap-y-1 lg:flex lg:flex-col">
