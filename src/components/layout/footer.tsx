...
// footer links
const footerLinks : NavLinkInterface[] = [
    { name: "Home", path: "/" , id: 0 },
        ...
        <footer className="flex flex-col items-center px-4 sm:px-14">
            <div className="flex flex-col pb-10 px-4 border-b border-b-[#D4D4D8] lg:flex-row lg:justify-between lg:w-full lg:items-center">
                ...
                <div className="flex gap-[34px] justify-center mt-[30px] lg:mt-0">
                    ...
                    <a href="https://facebook.com" className="text-2xl fill-primary">
                    ...
                    <a href="https://twitter.com/matintovhidi" className="text-2xl fill-primary">
                    ...
                    <a href="https://github.com/matintohidi" className="text-2xl fill-primary">
